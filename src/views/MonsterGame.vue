...
<!-- avatar -->
				<div class="container col-md-6">
					...
					<div class="progress healthbar  text-center">
						<div class="healthbar progress-bar"
							style="background-color: green; margin: 0; color: white; "							:style="{width: playerHealth + '%'}"
						>
							<b class="text-center">
							{{ playerHealth }}
							</b>
			...
			<section v-if="!gameIsRunning">
				<div class="controls">
					<button id="start-game" class="btn btn-primary btn-lg" @click="startGame">Start Game</button>
				</div>
			</section>
			<section class="" v-else>
				<div class="row controls acts">
					<button id="attack" class="btn btn-info shadow-lg" @click="attack">Attack</button>
					<button id="special-attack" class="btn btn-warning ml-2" @click="specialAttack">Special Attack</button>
					<button id="heal" class="btn btn-success ml-2" @click="heal">Heal</button>
					<button id="give-up" class="btn btn-danger ml-2" @click="giveUp">Give Up</button>
				</div>
			</section>
			<section class="row log container">
				<div class="small-12 columns text-center card mb-5" v-if="rounds.length > 0">
